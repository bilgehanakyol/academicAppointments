...
import AvailabilityManager from './pages/AcademianCalendarPage';
import CalendarView from './pages/StudentCalendarPage';
...
import StudentSearchPage from './pages/search/StudentSearchPage';
